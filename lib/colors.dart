...
class AppColor {
  static Color homePageBackground = const Color(0xfffcfcff);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xff4E66DF);
  static Color secondPageContainerGradient2ndColor = const Color(0xff5B79E3);
